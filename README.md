...
- structured customer data from a `.csv` file
...
Structured customer data is loaded from `.csv` under `data/structured/`.
...
2. the structured engine maps that intent to a supported operation
3. the answer is executed directly against the DataFrame
...
2. Strengthen structured intent coverage  
   Expand alias handling and semantic plan coverage while keeping execution deterministic.
